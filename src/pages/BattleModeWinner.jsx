...
const colorMap = {
  ...
  slate: { bg: 'bg-slate-300/10', border: 'border-slate-300/30', text: 'text-slate-200', hoverBorder: 'hover:border-slate-300/60', shadow: 'hover:shadow-slate-300/20', lightBg: 'bg-slate-300/5' },
